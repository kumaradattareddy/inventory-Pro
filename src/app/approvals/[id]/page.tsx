  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        setHamaliName(sale_data.hamaliName || "");
        setIsHamaliPaid(sale_data.isHamaliPaid || false);
        setTransport(String(sale_data.transport || ""));
        setTransportName(sale_data.transportName || "");
        setIsTransportPaid(sale_data.isTransportPaid || false);
